...
exports.getAllProductCategories = async(req, res) => {
    try {
        ...
        const productcategoriesList = await productcategoriesModels.allProductCategories(filterby, filter, sortby, order, page)
        return res.json({
            success: true,
...
exports.getProductCategoriesId = async(req, res) => {
    try {
        ...
        const productCategoriesData = await productcategoriesModels.findProductCategories(idProductCategories)
...
exports.createProductCategories = async (req, res) => {
    try {
        const productcategoriesNew = await productcategoriesModels.createdProductCategories(req.body);
        return res.json({
            success: true,
...
exports.updateProductCategories = async (req, res) => {
    try {
        ...
        const produtcategoriesUpdate = await productcategoriesModels.updatedProductCategories(idProdutCategories, req.body)
...
exports.deleteProductCategories = async (req, res) => {
    try {
        const idProductCategories = Number(req.params.id)
        const productcategoriesData = await productcategoriesModels.deletedProductCategories(idProductCategories)
