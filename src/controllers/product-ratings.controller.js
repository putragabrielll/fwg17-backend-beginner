...
exports.getAllProductRatings = async(req, res) => {
    try {
        ...
        const productcategoriesList = await productratingsModels.allProductRatings(filterby, filter, sortby, order, page)
        return res.json({
            success: true,
...
exports.getProductRatingsId = async(req, res) => {
    try {
        ...
        const productRatingsData = await productratingsModels.findProductRatings(idProductRatings)
...
exports.createProductRatings = async (req, res) => {
    try {
        const productratingsNew = await productratingsModels.createdProductRatings(req.body);
        return res.json({
            success: true,
...
exports.updateProductRatings = async (req, res) => {
    try {
        const idProductRatings = Number(req.params.id)
        const productratingsUpdate = await productratingsModels.updatedProductRatings(idProductRatings, req.body)
...
exports.deleteProductRatings = async (req, res) => {
    try {
        const idProductRatings = Number(req.params.id)
        const productratingsData = await productratingsModels.deletedProductRatings(idProductRatings)
