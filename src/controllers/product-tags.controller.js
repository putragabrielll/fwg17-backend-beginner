...
exports.getAllProdutTags = async(req, res) => {
    try {
        ...
        const productstagsList = await producttagsModels.allProductTags(filterby, filter, sortby, order, page)
        return res.json({
            success: true,
...
exports.getProdutTagsId = async(req, res) => {
    try {
        ...
        const productTagsData = await producttagsModels.findProductTags(idProductTags)
...
exports.updateProductTags = async (req, res) => {
    try {
        ...
        const produttagsUpdate = await producttagsModels.updatedProductTags(idProdutTags, req.body)
...
exports.deleteProductTags = async (req, res) => {
    try {
        const idProductTags = Number(req.params.id)
        const producttagsData = await producttagsModels.deletedProductTags(idProductTags)
