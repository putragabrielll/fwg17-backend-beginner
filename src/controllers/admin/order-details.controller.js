...
exports.getAllOrderDetails = async (req, res) => {
  try {
    ...
    const orderdetailsList = await orderdetailsModels.allOrderDetails(
      filterby,
      filter,
      sortby,
      order,
...
exports.getOrderDetailsId = async (req, res) => {
  try {
    ...
    const orderdetailsData = await orderdetailsModels.findOrderDetails(
      idOrderDetails
    );
...
exports.updateOrderDetails = async (req, res) => {
  try {
    const idOrderDetails = Number(req.params.id);
    const orderdetailsData = await orderdetailsModels.updatedOrderDetails(
      idOrderDetails,
      req.body
    );
...
exports.deleteOrderDetails = async (req, res) => {
  try {
    const idOrderDetails = Number(req.params.id);
    const orderdetailsData = await orderdetailsModels.deletedOrderDetails(
      idOrderDetails
    );
